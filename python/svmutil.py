...
__all__ = ['svm_load_model', 'svm_predict', 'svm_save_model', 'svm_train'
           ] + svm_all + common_all
...
def svm_train(arg1, arg2=None, arg3=None):
    ...
    if isinstance(arg1,
                  (list, tuple)) or (scipy
                                     and isinstance(arg1, scipy.ndarray)):
        assert isinstance(arg2, (list, tuple)) or (scipy and isinstance(
            arg2, (scipy.ndarray, sparse.spmatrix)))
